...
export class EditOrderComponent implements OnInit {
    ...
    editOrder(){
        if(this.orderForm.valid){
            ...
            this.editedOrder.orderItems = this.orderItemList; //pogledaj
    ...
    changedItems(){
        ...
        if(this.editedOrder.orderItems === null || this.editedOrder.orderItems === undefined) return true;
        if(this.order.orderItems.length !== this.editedOrder.orderItems.length) return true;
        // this.order.orderItems.forEach(item => {
        //     this.editedOrder.orderItems.forEach(editedItem => {
        //         if(item.)
        //     });
        // });
        return false;
